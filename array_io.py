...
def read_seven_arrays(fname):
  ...
  return a,b,c,d,f,g,h
def read_seven_arrays_skip_first_line(fname):
  fp = open(fname,"r")
  fl = fp.readlines()
  n = len(fl)-1
  a = np.zeros(n)
...
def read_twelve_arrays(fname):
  ...
  for i in range(n):
    ...
    l[i] = float(fl[i].split()[9])
    m[i] = float(fl[i].split()[10])
    q[i] = float(fl[i].split()[11])
  return a,b,c,d,f,g,h,j,k,l,m,q
...
def read_fourteen_arrays(fname):
  fp = open(fname,"r")
  fl = fp.readlines()
  n = len(fl)
  a = np.zeros(n)
  ...
  for i in range(n):
    ...
    p[i] = float(fl[i].split()[11])
    q[i] = float(fl[i].split()[12])
    r[i] = float(fl[i].split()[13])

  return a,b,c,d,f,g,h,j,k,l,m,p,q,r
...
def read_sixteen_arrays(fname):
  ...
  return a,b,c,d,f,g,h,j,k,l,m,p,aa,ab,ac,ad
